   ...
   <div class="container mt-4">                
                <div class="table-responsive">
                    <div class="fs-2 bg-dark text-white rounded fw-bold text-start">
                        <h1>Liste des Employés Homme dans dans le département <span class="ok"><?= $id['id']; ?></span> </h1>
                    ...
                    <div class="d-flex justify-content-between">
                        <?php if($n >= 20) { ?>
                            <a class="btn btn-success" href="man.php?num=<?= $num; ?>&n=<?= ($n - 20); ?>"> < Precedents</a>
                        <?php } else { ?>
                            <span></span>
                        <?php } ?>
                        <?php if(mysqli_num_rows(aff_liste_employer($num, $n + 20)) != 0) { ?>
                            <a class="btn btn-success" href="man.php?num=<?= $num; ?>&n=<?= ($n + 20); ?>">Suivants ></a>
                        <?php } ?>
                    </div>
                </div>
    </div>
